        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 flex flex-col justify-between gap-10">
            <div>
              ...
              <p className="text-secondaryText text-xs leading-relaxed mb-10 font-normal">
              ...
              <div className="flex flex-col gap-4">
                <a
                  ...
                  className="glass-panel p-4 rounded-xl flex items-center gap-4 hover:border-accent/30 hover:bg-white/[0.02] transition duration-300"
                >
                  <div className="w-10 h-10 rounded-lg bg-accent/10 border border-accent/20 text-accent flex items-center justify-center shadow-[0_0_10px_rgba(168,85,247,0.1)]">
                    <FaPhoneAlt size={14} />
                  </div>
                  <div>
                ...
                <a
                  ...
                  className="glass-panel p-4 rounded-xl flex items-center gap-4 hover:border-accent/30 hover:bg-white/[0.02] transition duration-300"
                >
                  <div className="w-10 h-10 rounded-lg bg-accentBlue/10 border border-accentBlue/20 text-accentBlue flex items-center justify-center shadow-[0_0_10px_rgba(59,130,246,0.1)]">
                    <FaEnvelope size={14} />
                  </div>
                  <div>
            ...
            <p className="hidden lg:block text-xs text-slate-500 mt-12 font-medium">
              &copy; {new Date().getFullYear()} Shaily Jadaun. All rights reserved.
            </p>
          </div>

          {/* Form Column */}
          <div className="lg:col-span-2 glass-panel p-8 md:p-10 rounded-2xl border border-white/5 relative overflow-hidden">
